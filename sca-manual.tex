...
A feature model is included with this distribution, \texttt{"features.model"}; the details of this model are described in the appendix (\ref{sub:mafm}). To load this model into a script, use the following command:
...
%Features which are \texttt{binary} can take values \texttt{+} or \texttt{-}; \texttt{ternary} can take values \texttt{+}, \texttt{-}, or \texttt{0}; \texttt{numeric} can take any integer value.
